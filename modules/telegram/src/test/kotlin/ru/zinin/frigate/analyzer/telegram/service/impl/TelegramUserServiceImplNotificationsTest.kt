...
class TelegramUserServiceImplNotificationsTest {
    ...
    @Test
    fun `updateNotificationsRecordingEnabled returns true when row updated`() =
        runTest {
    ...
    @Test
    fun `updateNotificationsRecordingEnabled returns false when no rows updated`() =
        runTest {
    ...
    @Test
    fun `updateNotificationsSignalEnabled returns true when row updated`() =
        runTest {
    ...
    @Test
    fun `updateNotificationsSignalEnabled returns false when no rows updated`() =
        runTest {
    ...
    @Test
    fun `getAuthorizedUsersWithZones populates notification flags`() =
        runTest {
            val users =
                listOf(
