...
All `RecordsWatcherProperties` fields have Kotlin defaults, and `first-scan-period` was appended as the **last** constructor parameter — never call the constructor positionally, only with named arguments.
